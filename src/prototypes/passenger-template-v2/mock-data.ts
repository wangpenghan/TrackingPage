...
export interface EditConfig {
  ...
  schedulePlan: string;
  // 新增字段 - 对齐既有系统
  responsibleBureau?: string; // 担当局
  passengerCapacity?: number; // 列车定员
  operator?: string; // 操作人员
  operateTime?: string; // 操作时间
  operationPattern?: string; // 运行规律
  arrivalCheckInTimeBase?: string; // 进站开检时间基准
  arrivalStopCheckTimeBase?: string; // 进站停检时间基准
  arrivalCheckInAdvance?: number; // 进站开检提前量
  arrivalStopCheckAdvance?: number; // 进站停检提前量
  departureCheckInAdvance?: number; // 出站开检提前量
  departureStopCheckAdvance?: number; // 出站停检提前量
}
